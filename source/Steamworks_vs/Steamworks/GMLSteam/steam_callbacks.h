...
public:
	...
	STEAM_CALLBACK(steam_net_callbacks_t, volume_has_changed, VolumeHasChanged_t);
	STEAM_CALLBACK(steam_net_callbacks_t, playback_status_has_changed, PlaybackStatusHasChanged_t);
