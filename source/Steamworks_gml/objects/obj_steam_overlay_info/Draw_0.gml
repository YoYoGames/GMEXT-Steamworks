...
draw_text(50,100 + _i++ * 30,$"steam_get_persona_name: {steam_friends_get_persona_name()}")
draw_text(50,100 + _i++ * 30,$"steam_is_overlay_enabled: {steam_utils_is_overlay_enabled()}")
