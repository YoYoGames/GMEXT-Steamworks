...
gm_enums::SteamUserBeginAuthSessionResult steam_user_begin_auth_session(gm::wire::GMBuffer auth_ticket, std::uint32_t buffer_offset, std::uint32_t buffer_count, std::uint64_t steam_id);
...
std::optional<gm_structs::SteamInventoryDeserializeResult> steam_inventory_deserialize_result(gm::wire::GMBuffer data, std::uint32_t buffer_offset, std::uint32_t buffer_count);
...
std::int32_t steam_networking_messages_send_message_to_user(std::uint64_t steam_id_remote, gm::wire::GMBuffer data, std::uint32_t buffer_offset, std::uint32_t buffer_count, std::int32_t send_flags, std::int32_t remote_channel);
...
std::int32_t steam_networking_sockets_send_message_to_connection(std::uint32_t conn, gm::wire::GMBuffer data, std::uint32_t buffer_offset, std::uint32_t buffer_count, gm_enums::SteamNetworkingSendFlags send_flags);
