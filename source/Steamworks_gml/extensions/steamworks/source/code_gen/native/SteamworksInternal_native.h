...
namespace gm_enums
{
    ...
    enum class SteamNetConnectionEnd : std::int64_t
    {
        Invalid = 0,
        App_Min = 1000,
        App_Generic = 1000,
...
namespace gm_structs
{
    ...
    {
        std::uint64_t steam_id_remote;
        gm_enums::SteamNetConnectionEnd end_reason;
...
namespace gm::wire::codec
{
    ...
    inline gm_structs::SteamNetworkingMessagesSessionFailed readValue<gm_structs::SteamNetworkingMessagesSessionFailed>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.steam_id_remote = gm::wire::codec::readValue<std::uint64_t>(_buf);
        obj.end_reason = gm::wire::codec::readValue<gm_enums::SteamNetConnectionEnd>(_buf);
...
gm_structs::SteamAppsLaunchCommandLine steam_apps_get_launch_command_line();
...
std::optional<gm_structs::SteamPartiesAvailableBeaconLocations> steam_parties_get_available_beacon_locations();
