...
std::int32_t steam_networking_sockets_send_message_to_connection(std::uint32_t conn, gm::wire::GMBuffer data, gm_enums::SteamNetworkingSendFlags send_flags, std::optional<std::uint32_t> buffer_offset, std::optional<std::uint32_t> buffer_count);
