...
std::uint32_t steam_screenshots_write_screenshot(gm::wire::GMBuffer buff_rgb, std::int32_t width, std::int32_t height);
...
gm_enums::SteamUserBeginAuthSessionResult steam_user_begin_auth_session(gm::wire::GMBuffer auth_ticket, std::uint64_t steam_id);
...
gm_enums::SteamApiVoiceResult steam_user_decompress_voice(gm::wire::GMBuffer compressed, gm::wire::GMBuffer dest, std::uint32_t desired_sample_rate);
...
std::optional<gm_structs::SteamInventoryDeserializeResult> steam_inventory_deserialize_result(gm::wire::GMBuffer data);
...
std::int32_t steam_networking_messages_send_message_to_user(std::uint64_t steam_id_remote, gm::wire::GMBuffer data, std::int32_t send_flags, std::int32_t remote_channel);
...
std::int32_t steam_networking_sockets_send_message_to_connection(std::uint32_t conn, gm::wire::GMBuffer data, gm_enums::SteamNetworkingSendFlags send_flags);
