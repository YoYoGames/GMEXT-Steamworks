...
namespace gm_consts
{
    inline constexpr std::int32_t STEAM_API_BREAKPAD_INVALID_HANDLE = 0;
    inline constexpr std::int32_t STEAM_API_GAME_EXTRA_INFO_MAX = 64;
    inline constexpr std::int32_t STEAM_API_SALT_SIZE = 8;
    inline constexpr std::int64_t STEAM_API_GID_NIL = -1;
    inline constexpr std::int32_t STEAM_API_AUTH_TICKET_INVALID = 0;
    inline constexpr std::int64_t STEAM_API_JOB_ID_NIL = -1;
    inline constexpr std::int64_t STEAM_API_TXN_ID_NIL = -1;
    inline constexpr std::int32_t STEAM_API_TXN_ID_UNKNOWN = 0;
    inline constexpr std::int32_t STEAM_API_API_CALL_INVALID = 0x0;
    inline constexpr std::int32_t STEAM_API_APP_ID_INVALID = 0x0;
    inline constexpr std::int32_t STEAM_API_BUNDLE_ID_INVALID = 0;
    inline constexpr std::int32_t STEAM_API_CELL_ID_INVALID = 0xFFFFFFFF;
    inline constexpr std::int32_t STEAM_API_DEPOT_ID_INVALID = 0x0;
    inline constexpr std::int32_t STEAM_API_ASSET_CLASS_ID_INVALID = 0x0;
    inline constexpr std::int32_t STEAM_API_MANIFEST_ID_INVALID = 0;
    inline constexpr std::int32_t STEAM_API_STEAM_ACCOUNT_ID_MASK = 0xFFFFFFFF;
    inline constexpr std::int32_t STEAM_API_STEAM_ACCOUNT_INSTANCE_MASK = 0x000FFFFF;
    inline constexpr std::int32_t STEAM_API_STEAM_USER_CONSOLE_INSTANCE = 2;
    inline constexpr std::int32_t STEAM_API_STEAM_USER_DESKTOP_INSTANCE = 1;
    inline constexpr std::int32_t STEAM_API_STEAM_USER_WEB_INSTANCE = 4;
    inline constexpr std::int32_t STEAM_API_PACKAGE_ID_FREE_SUB = 0x0;
    inline constexpr std::int32_t STEAM_API_PACKAGE_ID_INVALID = 0xFFFFFFFF;
    inline constexpr std::int32_t STEAM_API_PARTNER_ID_INVALID = 0;
    inline constexpr std::int32_t STEAM_API_PHYSICAL_ITEM_ID_INVALID = 0x0;
    inline constexpr std::int32_t STEAM_API_QUERY_PORT_ERROR = 0xFFFE;
    inline constexpr std::int32_t STEAM_API_QUERY_PORT_NOT_INITIALIZED = 0xFFFF;
    inline constexpr std::uint32_t STEAM_ID_NIL = 0;
    inline constexpr std::uint32_t STEAM_ID_NON_STEAM_GS = 2;
    inline constexpr std::int32_t STEAM_FRIENDS_MAX_FRIENDS_GROUP_NAME = 64;
    inline constexpr std::int32_t STEAM_FRIENDS_MAX_RICH_PRESENCE_KEY_LENGTH = 64;
    inline constexpr std::int32_t STEAM_FRIENDS_MAX_RICH_PRESENCE_KEYS = 20;
    inline constexpr std::int32_t STEAM_FRIENDS_MAX_RICH_PRESENCE_VALUE_LENGTH = 256;
    inline constexpr std::int32_t STEAM_FRIENDS_PERSONA_NAME_MAX = 128;
    inline constexpr std::int32_t STEAM_FRIENDS_ENUMERATE_FOLLOWERS_MAX = 50;
    inline constexpr std::int32_t STEAM_FRIENDS_FRIENDS_GROUP_LIMIT = 100;
    inline constexpr std::int32_t STEAM_FRIENDS_CHAT_METADATA_MAX = 8192;
    inline constexpr std::int32_t STEAM_FRIENDS_PERSONA_NAME_MAX_UTF16 = 32;
    inline constexpr std::int32_t STEAM_FRIENDS_GROUP_ID_INVALID = -1;
    inline constexpr std::string_view STEAM_FRIENDS_INTERFACE_VERSION = "SteamFriends015";
    inline constexpr std::int32_t STEAM_APPS_APP_PROOF_OF_PURCHASE_KEY_MAX = 240;
    inline constexpr std::string_view STEAM_APPS_INTERFACE_VERSION = "STEAMAPPS_INTERFACE_VERSION008";
    inline constexpr std::int32_t STEAM_SCREENSHOTS_INVALID_SCREENSHOT_HANDLE = 0;
    inline constexpr std::int32_t STEAM_SCREENSHOTS_UFS_TAG_TYPE_MAX = 255;
    inline constexpr std::int32_t STEAM_SCREENSHOTS_UFS_TAG_VALUE_MAX = 255;
    inline constexpr std::int32_t STEAM_SCREENSHOTS_MAX_TAGGED_PUBLISHED_FILES = 32;
    inline constexpr std::int32_t STEAM_SCREENSHOTS_MAX_TAGGED_USERS = 32;
    inline constexpr std::int32_t STEAM_SCREENSHOTS_THUMB_WIDTH = 200;
    inline constexpr std::string_view STEAM_SCREENSHOTS_INTERFACE_VERSION = "STEAMSCREENSHOTS_INTERFACE_VERSION003";
    inline constexpr std::string_view STEAM_USER_INTERFACE_VERSION = "SteamUser019";
    inline constexpr std::int32_t STEAM_USER_ENCRYPTED_APP_TICKET_SYMMETRIC_KEY_LEN = 32;
    inline constexpr std::string_view STEAM_UTILS_INTERFACE_VERSION = "SteamUtils009";
    inline constexpr std::int32_t STEAM_UGC_NUM_RESULTS_PER_PAGE = 50;
    inline constexpr std::int32_t STEAM_UGC_DEVELOPER_METADATA_MAX = 5000;
    ...
    inline constexpr std::int32_t STEAM_USER_STATS_STAT_NAME_MAX = 128;
    inline constexpr std::int32_t STEAM_USER_STATS_LEADERBOARD_DETAILS_MAX = 64;
    inline constexpr std::string_view STEAM_USER_STATS_INTERFACE_VERSION = "STEAMUSERSTATS_INTERFACE_VERSION011";
    inline constexpr std::string_view STEAM_MUSIC_INTERFACE_VERSION = "STEAMMUSIC_INTERFACE_VERSION001";
    ...
    inline constexpr std::int32_t STEAM_REMOTE_STORAGE_PUBLISHED_DOCUMENT_TITLE_MAX = 129;
    inline constexpr std::int32_t STEAM_REMOTE_STORAGE_PUBLISHED_FILE_URL_MAX = 256;
    inline constexpr std::int32_t STEAM_REMOTE_STORAGE_TAG_LIST_MAX = 1025;
    inline constexpr std::int32_t STEAM_REMOTE_STORAGE_PUBLISHED_FILE_ID_INVALID = 0;
    inline constexpr std::int64_t STEAM_REMOTE_STORAGE_PUBLISHED_FILE_UPDATE_HANDLE_INVALID = -1;
    inline constexpr std::int64_t STEAM_REMOTE_STORAGE_UGC_FILE_STREAM_HANDLE_INVALID = -1;
    inline constexpr std::int64_t STEAM_REMOTE_STORAGE_UGC_HANDLE_INVALID = -1;
    inline constexpr std::int32_t STEAM_REMOTE_STORAGE_ENUMERATE_PUBLISHED_FILES_MAX_RESULTS = 50;
    inline constexpr std::int32_t STEAM_REMOTE_STORAGE_MAX_CLOUD_FILE_CHUNK_SIZE = 104857600;
    inline constexpr std::string_view STEAM_REMOTE_STORAGE_INTERFACE_VERSION = "STEAMREMOTESTORAGE_INTERFACE_VERSION014";
    inline constexpr std::int32_t STEAM_MATCHMAKING_SERVER_QUERY_INVALID = 0xffffffff;
    inline constexpr std::int32_t STEAM_MATCHMAKING_MAX_LOBBY_KEY_LENGTH = 255;
    inline constexpr std::int32_t STEAM_MATCHMAKING_FAVORITE_FLAG_FAVORITE = 0x01;
    inline constexpr std::int32_t STEAM_MATCHMAKING_FAVORITE_FLAG_HISTORY = 0x02;
    inline constexpr std::int32_t STEAM_MATCHMAKING_FAVORITE_FLAG_NONE = 0x00;
    inline constexpr std::string_view STEAM_MATCHMAKING_SERVERS_INTERFACE_VERSION = "SteamMatchMakingServers002";
    inline constexpr std::string_view STEAM_MATCHMAKING_INTERFACE_VERSION = "SteamMatchMaking009";
    inline constexpr std::uint32_t STEAM_NETWORKING_POLL_GROUP_INVALID = 0;
    inline constexpr std::uint32_t STEAM_NETWORKING_SOCKETS_MAX_MESSAGE_SIZE_SEND = 524288;
}
...
namespace gm_enums
{
    ...
    enum class SteamMarketNotAllowedReasonFlags : std::int64_t
    {
        None = 0,
        TemporaryFailure = 1,
        AccountDisabled = 2,
    ...
    enum class SteamNetworkingConfigValue : std::int64_t
    {
        Invalid = 0,
        TimeoutInitial = 24,
        TimeoutConnected = 25,
...
namespace gm_structs
{
    ...
    {
        std::uint64_t steam_id;
        gm_enums::SteamFriendsPersonaChange change_flags;
    };
    ...
    struct SteamUserDurationControl
    {
        ...
        std::int32_t csecs_today;
        std::int32_t csecs_remaining;
    };

    struct SteamUserMarketEligibilityResponse
    {
        bool allowed;
        gm_enums::SteamMarketNotAllowedReasonFlags not_allowed_reason;
    ...
    struct SteamUserClientGameServerDeny
    {
        ...
        bool secure;
        gm_enums::SteamApiDenyReason reason;
    };
    ...
    {
        gm_enums::SteamApiResult result;
        std::int32_t num_eligible_promo_item_defs;
        bool cached_data;
    };
...
namespace gm::wire::codec
{
    ...
    inline gm_structs::SteamFriendsPersonaStateChange readValue<gm_structs::SteamFriendsPersonaStateChange>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.steam_id = gm::wire::codec::readValue<std::uint64_t>(_buf);
        obj.change_flags = gm::wire::codec::readValue<gm_enums::SteamFriendsPersonaChange>(_buf);
        return obj;
    }
    ...
    inline gm_structs::SteamAppsFileDetailsResult readValue<gm_structs::SteamAppsFileDetailsResult>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.result = gm::wire::codec::readValue<gm_enums::SteamApiResult>(_buf);
        obj.file_size = gm::wire::codec::readValue<std::int64_t>(_buf);
    ...
    inline void writeValue<gm_structs::SteamUserDurationControl>(gm::byteio::IByteWriter& _buf, const gm_structs::SteamUserDurationControl& obj)
    {
        ...
        gm::wire::codec::writeValue(_buf, obj.csecs_today);
        gm::wire::codec::writeValue(_buf, obj.csecs_remaining);
    }
    ...
    inline gm_structs::SteamUserDurationControl readValue<gm_structs::SteamUserDurationControl>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.csecs_today = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.csecs_remaining = gm::wire::codec::readValue<std::int32_t>(_buf);
        return obj;
    }
    ...
    inline gm_structs::SteamUserMarketEligibilityResponse readValue<gm_structs::SteamUserMarketEligibilityResponse>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.not_allowed_reason = gm::wire::codec::readValue<gm_enums::SteamMarketNotAllowedReasonFlags>(_buf);
    ...
    template<>
    inline void writeValue<gm_structs::SteamUserGetTicketForWebApiResponse>(gm::byteio::IByteWriter& _buf, const gm_structs::SteamUserGetTicketForWebApiResponse& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.auth_ticket_handle);
        gm::wire::codec::writeValue(_buf, obj.result);
        gm::wire::codec::writeValue(_buf, obj.ticket_size);
    ...
    template<>
    inline gm_structs::SteamUserGetTicketForWebApiResponse readValue<gm_structs::SteamUserGetTicketForWebApiResponse>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::SteamUserGetTicketForWebApiResponse obj;
        obj.auth_ticket_handle = gm::wire::codec::readValue<std::uint32_t>(_buf);
        obj.result = gm::wire::codec::readValue<gm_enums::SteamApiResult>(_buf);
        obj.ticket_size = gm::wire::codec::readValue<std::uint32_t>(_buf);
        return obj;
    ...
    inline gm_structs::SteamUserClientGameServerDeny readValue<gm_structs::SteamUserClientGameServerDeny>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.reason = gm::wire::codec::readValue<gm_enums::SteamApiDenyReason>(_buf);
        return obj;
    }
    ...
    template<>
    inline void writeValue<gm_structs::SteamUgcWorkshopEULAStatusResult>(gm::byteio::IByteWriter& _buf, const gm_structs::SteamUgcWorkshopEULAStatusResult& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.result);
        gm::wire::codec::writeValue(_buf, obj.app_id);
        gm::wire::codec::writeValue(_buf, obj.version);
        gm::wire::codec::writeValue(_buf, obj.time_action);
        gm::wire::codec::writeValue(_buf, obj.accepted);
        gm::wire::codec::writeValue(_buf, obj.needs_action);
    }

    template<>
    inline gm_structs::SteamUgcWorkshopEULAStatusResult readValue<gm_structs::SteamUgcWorkshopEULAStatusResult>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::SteamUgcWorkshopEULAStatusResult obj;
        obj.result = gm::wire::codec::readValue<gm_enums::SteamApiResult>(_buf);
        obj.app_id = gm::wire::codec::readValue<std::uint32_t>(_buf);
        obj.version = gm::wire::codec::readValue<std::uint32_t>(_buf);
        obj.time_action = gm::wire::codec::readValue<std::uint32_t>(_buf);
        obj.accepted = gm::wire::codec::readValue<bool>(_buf);
        obj.needs_action = gm::wire::codec::readValue<bool>(_buf);
        return obj;
    }
    ...
    inline void writeValue<gm_structs::SteamUserStatsMostAchievedAchievementInfo>(gm::byteio::IByteWriter& _buf, const gm_structs::SteamUserStatsMostAchievedAchievementInfo& obj)
    {
        ...
        gm::wire::codec::writeValue(_buf, obj.achieved);
        gm::wire::codec::writeValue(_buf, obj.iterator);
    }
    ...
    inline gm_structs::SteamUserStatsMostAchievedAchievementInfo readValue<gm_structs::SteamUserStatsMostAchievedAchievementInfo>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.achieved = gm::wire::codec::readValue<bool>(_buf);
        obj.iterator = gm::wire::codec::readValue<std::int32_t>(_buf);
        return obj;
    }
    ...
    template<>
    inline void writeValue<gm_structs::SteamInventoryEligiblePromoItemDefIdsResult>(gm::byteio::IByteWriter& _buf, const gm_structs::SteamInventoryEligiblePromoItemDefIdsResult& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.result);
        gm::wire::codec::writeValue(_buf, obj.num_eligible_promo_item_defs);
        gm::wire::codec::writeValue(_buf, obj.cached_data);
    }

    template<>
    inline gm_structs::SteamInventoryEligiblePromoItemDefIdsResult readValue<gm_structs::SteamInventoryEligiblePromoItemDefIdsResult>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::SteamInventoryEligiblePromoItemDefIdsResult obj;
        obj.result = gm::wire::codec::readValue<gm_enums::SteamApiResult>(_buf);
        obj.num_eligible_promo_item_defs = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.cached_data = gm::wire::codec::readValue<bool>(_buf);
        return obj;
    }
    ...
    template<>
    inline void writeValue<gm_structs::SteamMatchmakingLobbyDataEntry>(gm::byteio::IByteWriter& _buf, const gm_structs::SteamMatchmakingLobbyDataEntry& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.key);
        gm::wire::codec::writeValue(_buf, obj.value);
    }
    ...
    template<>
    inline gm_structs::SteamMatchmakingLobbyDataEntry readValue<gm_structs::SteamMatchmakingLobbyDataEntry>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::SteamMatchmakingLobbyDataEntry obj;
        obj.key = gm::wire::codec::readValue<std::string>(_buf);
        obj.value = gm::wire::codec::readValue<std::string>(_buf);
        return obj;
    }
...
namespace gm::wire::details
{
    ...
    template<>
    struct gm_struct_traits<gm_structs::SteamUserGetTicketForWebApiResponse>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::SteamInventoryEligiblePromoItemDefIdsResult>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::SteamMatchmakingLobbyDataEntry>
    {
        static constexpr bool is_gm_struct = true;
...
std::uint32_t steam_apps_get_app_ownership_ticket_data(std::uint32_t app_id, gm::wire::GMBuffer ticket_buffer);
...
gm_enums::SteamUserBeginAuthSessionResult steam_user_begin_auth_session(gm::wire::GMBuffer auth_ticket, std::uint64_t steam_id, std::optional<std::uint32_t> buffer_offset, std::optional<std::uint32_t> buffer_count);
...
gm_structs::SteamUserDecompressVoiceResult steam_user_decompress_voice(gm::wire::GMBuffer compressed, gm::wire::GMBuffer dest, std::uint32_t desired_sample_rate, std::optional<std::uint32_t> buffer_offset, std::optional<std::uint32_t> buffer_count);
void steam_user_end_auth_session(std::uint64_t steam_id);
gm_structs::SteamUserAuthSessionTicket steam_user_get_auth_session_ticket(gm::wire::GMBuffer out_ticket, std::optional<gm_enums::SteamNetworkingIdentityType> identity_type, const gm::wire::GMValue& identity_value);
...
gm_structs::SteamUserGetVoiceResult steam_user_get_voice(bool want_compressed, gm::wire::GMBuffer dest_compressed, bool want_uncompressed, gm::wire::GMBuffer dest_uncompressed, std::uint32_t desired_sample_rate);
...
std::optional<bool> steam_utils_get_api_call_result(std::uint64_t steam_api_call, std::int32_t callback_expected, gm::wire::GMBuffer out_callback);
...
std::optional<gm_structs::SteamInventoryDeserializeResult> steam_inventory_deserialize_result(gm::wire::GMBuffer data, std::optional<std::uint32_t> buffer_offset, std::optional<std::uint32_t> buffer_count);
...
std::optional<std::uint32_t> steam_inventory_serialize_result(std::int32_t result_handle, gm::wire::GMBuffer out_data);
...
bool steam_inventory_remove_property(std::uint64_t update_handle, std::uint64_t item_instance_id, std::string_view property_name);
bool steam_inventory_set_property_string(std::uint64_t update_handle, std::uint64_t item_instance_id, std::string_view property_name, std::string_view value);
bool steam_inventory_set_property_bool(std::uint64_t update_handle, std::uint64_t item_instance_id, std::string_view property_name, bool value);
bool steam_inventory_set_property_int64(std::uint64_t update_handle, std::uint64_t item_instance_id, std::string_view property_name, std::int64_t value);
bool steam_inventory_set_property_float(std::uint64_t update_handle, std::uint64_t item_instance_id, std::string_view property_name, float value);
std::int32_t steam_inventory_submit_update_properties(std::uint64_t update_handle, const gm::wire::GMFunction& callback);
...
std::int32_t steam_remote_storage_ugc_read(std::uint64_t ugc_handle, gm::wire::GMBuffer out_data, std::uint32_t offset, gm_enums::SteamRemoteStorageUgcReadAction action);
...
std::optional<gm_structs::SteamMatchmakingLobbyDataEntry> steam_matchmaking_get_lobby_data_by_index(std::uint64_t lobby_id, std::int32_t index);
...
gm_enums::SteamApiResult steam_networking_sockets_send_message_to_connection(std::uint32_t conn, gm::wire::GMBuffer data, gm_enums::SteamNetworkingSendFlags send_flags, std::optional<std::uint32_t> buffer_offset, std::optional<std::uint32_t> buffer_count);
