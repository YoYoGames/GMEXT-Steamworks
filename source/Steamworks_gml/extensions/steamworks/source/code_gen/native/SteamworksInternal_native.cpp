...
GMEXPORT double __EXT_NATIVE__steam_api_init(double own_app_id)
{
    auto&& __result = steam_api_init(static_cast<std::uint32_t>(own_app_id));
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_api_restart_app_if_necessary(double own_app_id)
{
    auto&& __result = steam_api_restart_app_if_necessary(static_cast<std::uint32_t>(own_app_id));
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_activate_game_overlay(char* dialog)
{
    steam_friends_activate_game_overlay(dialog);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_activate_game_overlay_invite_dialog(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    steam_friends_activate_game_overlay_invite_dialog(steam_id_lobby);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_activate_game_overlay_to_user(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: dialog, type: String
    std::string_view dialog = gm::wire::codec::readValue<std::string_view>(__br);

    // field: steam_id, type: UInt64
    std::uint64_t steam_id = gm::wire::codec::readValue<std::uint64_t>(__br);

    steam_friends_activate_game_overlay_to_user(dialog, steam_id);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_close_clan_chat_window_in_steam(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_close_clan_chat_window_in_steam(steam_id_clan_chat);
    return static_cast<double>(__result);
}
...
GMEXPORT char* __EXT_NATIVE__steam_friends_get_clan_name(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    static std::string __result;
    __result = steam_friends_get_clan_name(steam_id_clan);
    return (char*)__result.c_str();
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_clan_officer_by_index(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // field: officer, type: Int32
    std::int32_t officer = gm::wire::codec::readValue<std::int32_t>(__br);

    auto&& __result = steam_friends_get_clan_officer_by_index(steam_id_clan, officer);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_clan_officer_count(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_clan_officer_count(steam_id_clan);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_clan_owner(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_clan_owner(steam_id_clan);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT char* __EXT_NATIVE__steam_friends_get_clan_tag(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    static std::string __result;
    __result = steam_friends_get_clan_tag(steam_id_clan);
    return (char*)__result.c_str();
}
...
{
    auto&& __result = steam_friends_get_coplay_friend(static_cast<std::int32_t>(coplay_friend));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_coplay_game(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_coplay_game(steam_id_friend);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_coplay_time(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_coplay_time(steam_id_friend);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_count_from_source(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_count_from_source(steam_id_source);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_from_source_by_index(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_from_source_by_index(steam_id_source, friend_index);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT char* __EXT_NATIVE__steam_friends_get_friend_persona_name(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    static std::string __result;
    __result = steam_friends_get_friend_persona_name(steam_id_friend);
    return (char*)__result.c_str();
}
...
GMEXPORT char* __EXT_NATIVE__steam_friends_get_friend_persona_name_history(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: persona_name, type: Int32
    std::int32_t persona_name = gm::wire::codec::readValue<std::int32_t>(__br);

    static std::string __result;
    __result = steam_friends_get_friend_persona_name_history(steam_id_friend, persona_name);
    return (char*)__result.c_str();
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_persona_state(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_persona_state(steam_id_friend);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_relationship(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_relationship(steam_id_friend);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friend_rich_presence_key_count(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_get_friend_rich_presence_key_count(steam_id_friend);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friends_group_id_by_index(double fg)
{
    auto&& __result = steam_friends_get_friends_group_id_by_index(static_cast<std::int32_t>(fg));
    return static_cast<double>(__result);
}

GMEXPORT char* __EXT_NATIVE__steam_friends_get_friends_group_name(double friends_group_id)
{
    static std::string __result;
    __result = steam_friends_get_friends_group_name(static_cast<std::int32_t>(friends_group_id));
    return (char*)__result.c_str();
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_get_friends_group_members_count(double friends_group_id)
{
    auto&& __result = steam_friends_get_friends_group_members_count(static_cast<std::int32_t>(friends_group_id));
    return static_cast<double>(__result);
}

GMEXPORT double __EXT_NATIVE__steam_friends_get_friends_group_members_list(double friends_group_id, char* __ret_buffer, double __ret_buffer_length)
{
    auto&& __result = steam_friends_get_friends_group_members_list(static_cast<std::int32_t>(friends_group_id));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT char* __EXT_NATIVE__steam_friends_get_player_nickname(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: steam_id_player, type: UInt64
    std::uint64_t steam_id_player = gm::wire::codec::readValue<std::uint64_t>(__br);

    static std::string __result;
    __result = steam_friends_get_player_nickname(steam_id_player);
    return (char*)__result.c_str();
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_invite_user_to_game(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_invite_user_to_game(steam_id_friend, connect_string);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_is_clan_chat_admin(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_is_clan_chat_admin(steam_id_clan_chat, steam_id_user);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_is_clan_public(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_is_clan_public(steam_id_clan);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_is_clan_official_game_group(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_is_clan_official_game_group(steam_id_clan);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_is_clan_chat_window_open_in_steam(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_friends_is_clan_chat_window_open_in_steam(steam_id_clan_chat);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_request_friend_rich_presence(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    steam_friends_request_friend_rich_presence(steam_id_friend);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_request_user_information(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: require_name_only, type: Bool
    bool require_name_only = gm::wire::codec::readValue<bool>(__br);

    auto&& __result = steam_friends_request_user_information(steam_id_user, require_name_only);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_set_in_game_voice_speaking(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    bool speaking = gm::wire::codec::readValue<bool>(__br);

    steam_friends_set_in_game_voice_speaking(steam_id_user, speaking);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_friends_set_played_with(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: steam_id_user_played_with, type: UInt64
    std::uint64_t steam_id_user_played_with = gm::wire::codec::readValue<std::uint64_t>(__br);

    steam_friends_set_played_with(steam_id_user_played_with);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_apps_get_dlc_data_by_index(double dlc, char* __ret_buffer, double __ret_buffer_length)
{
...
GMEXPORT double __EXT_NATIVE__steam_apps_is_dlc_installed(double app_id)
{
    auto&& __result = steam_apps_is_dlc_installed(static_cast<std::uint32_t>(app_id));
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_apps_is_subscribed_app(double app_id)
{
    auto&& __result = steam_apps_is_subscribed_app(static_cast<std::uint32_t>(app_id));
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_apps_get_beta_info(double beta_index, char* __ret_buffer, double __ret_buffer_length)
{
...
GMEXPORT double __EXT_NATIVE__steam_apps_set_active_beta(char* beta_name)
{
    auto&& __result = steam_apps_set_active_beta(beta_name);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_apps_get_dlc_download_progress(double app_id, char* __ret_buffer, double __ret_buffer_length)
{
...
{
    auto&& __result = steam_apps_get_earliest_purchase_unix_time(static_cast<std::uint32_t>(app_id));
    return static_cast<double>(__result);
}
...
{
    auto&& __result = steam_apps_get_installed_depots(static_cast<std::uint32_t>(app_id), static_cast<std::uint32_t>(max_depots));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
{
    steam_apps_install_dlc(static_cast<std::uint32_t>(app_id));
    return 0;
}
...
{
    steam_apps_uninstall_dlc(static_cast<std::uint32_t>(app_id));
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_screenshots_add_screenshot_to_library(char* filename, char* thumbnail_filename, double width, double height)
{
    auto&& __result = steam_screenshots_add_screenshot_to_library(filename, thumbnail_filename, static_cast<std::int32_t>(width), static_cast<std::int32_t>(height));
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_screenshots_hook_screenshots(double hook)
{
    steam_screenshots_hook_screenshots(static_cast<bool>(hook));
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_screenshots_set_location(double screenshot, char* location)
{
    auto&& __result = steam_screenshots_set_location(static_cast<std::uint32_t>(screenshot), location);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_screenshots_tag_published_file(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: screenshot, type: UInt32
    std::uint32_t screenshot = gm::wire::codec::readValue<std::uint32_t>(__br);

    // field: published_file_id, type: UInt64
    std::uint64_t published_file_id = gm::wire::codec::readValue<std::uint64_t>(__br);

    auto&& __result = steam_screenshots_tag_published_file(screenshot, published_file_id);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_screenshots_tag_user(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    auto&& __result = steam_screenshots_tag_user(screenshot, steam_id);
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_user_advertise_game(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    std::uint32_t server_ip = gm::wire::codec::readValue<std::uint32_t>(__br);

    // field: server_port, type: UInt32
    std::uint32_t server_port = gm::wire::codec::readValue<std::uint32_t>(__br);

    steam_user_advertise_game(steam_id_game_server, server_ip, server_port);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_user_cancel_auth_ticket(double auth_ticket_handle)
{
    steam_user_cancel_auth_ticket(static_cast<std::uint32_t>(auth_ticket_handle));
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_user_get_voice(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // field: want_compressed, type: Bool
    bool want_compressed = gm::wire::codec::readValue<bool>(__br);
...
{
    auto&& __result = steam_user_get_game_badge_level(static_cast<std::int32_t>(series), static_cast<bool>(foil));
    return static_cast<double>(__result);
}
...
GMEXPORT double __EXT_NATIVE__steam_user_track_app_usage_event(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: app_usage_event, type: Int32
    std::int32_t app_usage_event = gm::wire::codec::readValue<std::int32_t>(__br);

    // field: extra_info, type: String
    std::string_view extra_info = gm::wire::codec::readValue<std::string_view>(__br);

    steam_user_track_app_usage_event(game_id, app_usage_event, extra_info);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_utils_get_image_rgba(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    std::int32_t image_handle = gm::wire::codec::readValue<std::int32_t>(__br);
...
GMEXPORT double __EXT_NATIVE__steam_utils_get_image_size(double image_handle, char* __ret_buffer, double __ret_buffer_length)
{
...
GMEXPORT double __EXT_NATIVE__steam_utils_set_overlay_notification_inset(double horizontal_inset, double vertical_inset)
{
    steam_utils_set_overlay_notification_inset(static_cast<std::int32_t>(horizontal_inset), static_cast<std::int32_t>(vertical_inset));
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_utils_set_vr_headset_streaming_enabled(double enabled)
{
    steam_utils_set_vr_headset_streaming_enabled(static_cast<bool>(enabled));
    return 0;
}
...
{
    steam_utils_set_game_launcher_mode(static_cast<bool>(launcher_mode));
    return 0;
}
...
{
    auto&& __result = steam_ugc_get_subscribed_items(static_cast<std::uint32_t>(max_entries), static_cast<bool>(include_locally_disabled));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_ugc_get_query_ugc_children(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // field: max_entries, type: UInt32
    std::uint32_t max_entries = gm::wire::codec::readValue<std::uint32_t>(__br);

    auto&& __result = steam_ugc_get_query_ugc_children(query_handle, index, max_entries);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_input_get_action_set_handle(char* action_set_name, char* __ret_buffer, double __ret_buffer_length)
{
    auto&& __result = steam_input_get_action_set_handle(action_set_name);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
{
    auto&& __result = steam_input_get_analog_action_handle(action_name);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
{
    auto&& __result = steam_input_get_controller_for_gamepad_index(static_cast<std::int32_t>(index));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
{
    auto&& __result = steam_input_get_digital_action_handle(action_name);
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_input_set_led_color(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: color_r, type: UInt32
    std::uint32_t color_r = gm::wire::codec::readValue<std::uint32_t>(__br);

    // field: color_g, type: UInt32
    std::uint32_t color_g = gm::wire::codec::readValue<std::uint32_t>(__br);
...
GMEXPORT double __EXT_NATIVE__steam_input_trigger_vibration(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: left_speed, type: UInt32
    std::uint32_t left_speed = gm::wire::codec::readValue<std::uint32_t>(__br);

    // field: right_speed, type: UInt32
    std::uint32_t right_speed = gm::wire::codec::readValue<std::uint32_t>(__br);

    steam_input_trigger_vibration(input_handle, left_speed, right_speed);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_input_trigger_vibration_extended(char* __arg_buffer, double __arg_buffer_length)
{
    ...
    // field: left_trigger_speed, type: UInt32
    std::uint32_t left_trigger_speed = gm::wire::codec::readValue<std::uint32_t>(__br);

    // field: right_trigger_speed, type: UInt32
    std::uint32_t right_trigger_speed = gm::wire::codec::readValue<std::uint32_t>(__br);

    steam_input_trigger_vibration_extended(input_handle, left_speed, right_speed, left_trigger_speed, right_trigger_speed);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_userstats_get_stat_int(char* stat_name, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<Int32>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_userstats_get_stat_float(char* stat_name, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<Float32>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_userstats_global_stat_int64(char* stat_name, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<Int64>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_userstats_global_stat_double(char* stat_name, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<Float64>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
{
    auto&& __result = steam_inventory_get_eligible_promo_item_definition_ids(static_cast<std::uint32_t>(max_item_defs));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
{
    auto&& __result = steam_inventory_get_item_definition_ids(static_cast<std::uint32_t>(max_item_defs));
    gm::byteio::BufferWriter __bw{__ret_buffer, static_cast<size_t>(__ret_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_remote_storage_get_file_name_and_size(double index, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<struct SteamRemoteStorageFileNameAndSize>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_remote_storage_get_quota(char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<struct SteamRemoteStorageQuota>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_remote_storage_get_ugc_details(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<struct SteamRemoteStorageUgcDetails>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
...
GMEXPORT double __EXT_NATIVE__steam_networking_messages_receive_one_on_channel(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<struct SteamNetworkingMessagesReceived>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}

GMEXPORT double __EXT_NATIVE__steam_networking_messages_receive_messages_on_channel(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    gm::byteio::BufferReader __br{__arg_buffer, static_cast<size_t>(__arg_buffer_length)};
...
GMEXPORT double __EXT_NATIVE__steam_networking_sockets_receive_one_on_connection(char* __arg_buffer, double __arg_buffer_length, char* __ret_buffer, double __ret_buffer_length)
{
    ...
    // return: __result, type: optional<struct SteamNetworkingSocketsReceived>
    gm::wire::codec::writeValue(__bw, __result);
    return 0;
}
