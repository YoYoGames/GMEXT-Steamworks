...
#if defined(_GAMING_XBOX) || defined(WIN_CLASSIC) || defined(YYXBOX) || defined(WIN_UAP)
/* Don't conflict with "boolean" type present in GDK SDK (or Windows 10 SDK on Windows)*/
 ...
 */
#if defined(__GNUC__) && !defined(__STRICT_ANSI__) && !defined(__psp__)
...
# define json_object_object_foreach(obj,key,val) \
 char *key=NULL; struct json_object *val=NULL; struct lh_entry *entry=NULL; \
...
extern struct json_object* json_object_new_null();
