...
/**
 * @struct_partial SteamInventoryItemDetails
 * @member {Real} item_instance_id
 * @member {Real} item_def_id
 * @member {Real} quantity
 * @member {Enum.SteamInventoryItemFlags} flags
 * @struct_end
 */
 ...
 * @member SteamApiBreakpadInvalidHandle (value: '0')
 * @member SteamApiGameExtraInfoMax (value: '64')
 * @member SteamApiSaltSize (value: '8')
 * @member SteamApiGidNil (value: '-1')
 * @member SteamApiAuthTicketInvalid (value: '0')
 * @member SteamApiJobIdNil (value: '-1')
 * @member SteamApiTxnIdNil (value: '-1')
 * @member SteamApiTxnIdUnknown (value: '0')
 * @member SteamApiApiCallInvalid (value: '0x0')
 * @member SteamApiAppIdInvalid (value: '0x0')
 * @member SteamApiBundleIdInvalid (value: '0')
 * @member SteamApiCellIdInvalid (value: '0xFFFFFFFF')
 * @member SteamApiDepotIdInvalid (value: '0x0')
 * @member SteamApiAssetClassIdInvalid (value: '0x0')
 * @member SteamApiManifestIdInvalid (value: '0')
 * @member SteamApiSteamAccountIdMask (value: '0xFFFFFFFF')
 * @member SteamApiSteamAccountInstanceMask (value: '0x000FFFFF')
 * @member SteamApiSteamUserConsoleInstance (value: '2')
 * @member SteamApiSteamUserDesktopInstance (value: '1')
 * @member SteamApiSteamUserWebInstance (value: '4')
 * @member SteamApiPackageIdFreeSub (value: '0x0')
 * @member SteamApiPackageIdInvalid (value: '0xFFFFFFFF')
 * @member SteamApiPartnerIdInvalid (value: '0')
 * @member SteamApiPhysicalItemIdInvalid (value: '0x0')
 * @member SteamApiQueryPortError (value: '0xFFFE')
 * @member SteamApiQueryPortNotInitialized (value: '0xFFFF')
 * @member SteamIDNil (value: '0')
 * @member SteamIDNonSteamGS (value: '2')
 * @member SteamFriendsMaxFriendsGroupName (value: '64')
 * @member SteamFriendsMaxRichPresenceKeyLength (value: '64')
 * @member SteamFriendsMaxRichPresenceKeys (value: '20')
 * @member SteamFriendsMaxRichPresenceValueLength (value: '256')
 * @member SteamFriendsPersonaNameMax (value: '128')
 * @member SteamFriendsEnumerateFollowersMax (value: '50')
 * @member SteamFriendsFriendsGroupLimit (value: '100')
 * @member SteamFriendsChatMetadataMax (value: '8192')
 * @member SteamFriendsPersonaNameMaxUtf16 (value: '32')
 * @member SteamFriendsGroupIdInvalid (value: '-1')
 * @member SteamFriendsInterfaceVersion (value: '"SteamFriends015"')
 * @member SteamAppsAppProofOfPurchaseKeyMax (value: '240')
 * @member SteamAppsInterfaceVersion (value: '"STEAMAPPS_INTERFACE_VERSION008"')
 * @member SteamScreenshotsInvalidScreenshotHandle (value: '0')
 * @member SteamScreenshotsUfsTagTypeMax (value: '255')
 * @member SteamScreenshotsUfsTagValueMax (value: '255')
 * @member SteamScreenshotsMaxTaggedPublishedFiles (value: '32')
 * @member SteamScreenshotsMaxTaggedUsers (value: '32')
 * @member SteamScreenshotsThumbWidth (value: '200')
 * @member SteamScreenshotsInterfaceVersion (value: '"STEAMSCREENSHOTS_INTERFACE_VERSION003"')
 * @member SteamUserInterfaceVersion (value: '"SteamUser019"')
 * @member SteamUserEncryptedAppTicketSymmetricKeyLen (value: '32')
 * @member SteamUtilsInterfaceVersion (value: '"SteamUtils009"')
 * @member SteamUgcNumResultsPerPage (value: '50')
 * @member SteamUgcDeveloperMetadataMax (value: '5000')
 * @member SteamUgcQueryHandleInvalid (value: '-1')
 * @member SteamUgcUpdateHandleInvalid (value: '-1')
 * @member SteamUgcInterfaceVersion (value: '"STEAMUGC_INTERFACE_VERSION015"')
 * @member SteamInputInterfaceVersion (value: '"SteamInput001"')
 * @member SteamInputHandleAllControllers (value: '-1')
 * @member SteamInputMaxAnalogActions (value: '16')
 * @member SteamInputMaxAnalogActionData (value: '1.0')
 * @member SteamInputMaxCount (value: '16')
 * @member SteamInputMaxDigitalActions (value: '128')
 * @member SteamInputMaxOrigins (value: '8')
 * @member SteamInputMinAnalogActionData (value: '-1.0')
 * @member SteamUserStatsLeaderboardNameMax (value: '128')
 * @member SteamUserStatsStatNameMax (value: '128')
 * @member SteamUserStatsLeaderboardDetailsMax (value: '64')
 * @member SteamUserStatsInterfaceVersion (value: '"STEAMUSERSTATS_INTERFACE_VERSION011"')
 * @member SteamMusicInterfaceVersion (value: '"STEAMMUSIC_INTERFACE_VERSION001"')
 * @member SteamTimelineMaxTimelinePriority (value: '1000')
 * @member SteamInventoryResultInvalid (value: '-1')
 * @member SteamInventoryItemInstanceIdInvalid (value: '-1')
 * @member SteamInventoryInterfaceVersion (value: '"STEAMINVENTORY_INTERFACE_V002"')
 * @member SteamRemoteStorageFilenameMax (value: '260')
 * @member SteamRemoteStoragePublishedDocumentChangeDescriptionMax (value: '8000')
 * @member SteamRemoteStoragePublishedDocumentDescriptionMax (value: '8000')
 * @member SteamRemoteStoragePublishedDocumentTitleMax (value: '129')
 * @member SteamRemoteStoragePublishedFileUrlMax (value: '256')
 * @member SteamRemoteStorageTagListMax (value: '1025')
 * @member SteamRemoteStoragePublishedFileIdInvalid (value: '0')
 * @member SteamRemoteStoragePublishedFileUpdateHandleInvalid (value: '-1')
 * @member SteamRemoteStorageUgcFileStreamHandleInvalid (value: '-1')
 * @member SteamRemoteStorageUgcHandleInvalid (value: '-1')
 * @member SteamRemoteStorageEnumeratePublishedFilesMaxResults (value: '50')
 * @member SteamRemoteStorageMaxCloudFileChunkSize (value: '104857600')
 * @member SteamRemoteStorageInterfaceVersion (value: '"STEAMREMOTESTORAGE_INTERFACE_VERSION014"')
 * @member SteamMatchmakingServerQueryInvalid (value: '0xffffffff')
 * @member SteamMatchmakingMaxLobbyKeyLength (value: '255')
 * @member SteamMatchmakingFavoriteFlagFavorite (value: '0x01')
 * @member SteamMatchmakingFavoriteFlagHistory (value: '0x02')
 * @member SteamMatchmakingFavoriteFlagNone (value: '0x00')
 * @member SteamMatchmakingServersInterfaceVersion (value: '"SteamMatchMakingServers002"')
 * @member SteamMatchmakingInterfaceVersion (value: '"SteamMatchMaking009"')
 * @member SteamNetworkingPollGroup_Invalid (value: '0')
 * @member SteamNetworkingSocketsMaxMessageSizeSend (value: '524288')
 * @const_end
 */
