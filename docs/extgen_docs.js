 ...
 * @member STEAM_API_BREAKPAD_INVALID_HANDLE (value: '0')
 * @member STEAM_API_GAME_EXTRA_INFO_MAX (value: '64')
 * @member STEAM_API_SALT_SIZE (value: '8')
 * @member STEAM_API_GID_NIL (value: '-1')
 * @member STEAM_API_AUTH_TICKET_INVALID (value: '0')
 * @member STEAM_API_JOB_ID_NIL (value: '-1')
 * @member STEAM_API_TXN_ID_NIL (value: '-1')
 * @member STEAM_API_TXN_ID_UNKNOWN (value: '0')
 * @member STEAM_API_API_CALL_INVALID (value: '0x0')
 * @member STEAM_API_APP_ID_INVALID (value: '0x0')
 * @member STEAM_API_BUNDLE_ID_INVALID (value: '0')
 * @member STEAM_API_CELL_ID_INVALID (value: '0xFFFFFFFF')
 * @member STEAM_API_DEPOT_ID_INVALID (value: '0x0')
 * @member STEAM_API_ASSET_CLASS_ID_INVALID (value: '0x0')
 * @member STEAM_API_MANIFEST_ID_INVALID (value: '0')
 * @member STEAM_API_STEAM_ACCOUNT_ID_MASK (value: '0xFFFFFFFF')
 * @member STEAM_API_STEAM_ACCOUNT_INSTANCE_MASK (value: '0x000FFFFF')
 * @member STEAM_API_STEAM_USER_CONSOLE_INSTANCE (value: '2')
 * @member STEAM_API_STEAM_USER_DESKTOP_INSTANCE (value: '1')
 * @member STEAM_API_STEAM_USER_WEB_INSTANCE (value: '4')
 * @member STEAM_API_PACKAGE_ID_FREE_SUB (value: '0x0')
 * @member STEAM_API_PACKAGE_ID_INVALID (value: '0xFFFFFFFF')
 * @member STEAM_API_PARTNER_ID_INVALID (value: '0')
 * @member STEAM_API_PHYSICAL_ITEM_ID_INVALID (value: '0x0')
 * @member STEAM_API_QUERY_PORT_ERROR (value: '0xFFFE')
 * @member STEAM_API_QUERY_PORT_NOT_INITIALIZED (value: '0xFFFF')
 * @member STEAM_ID_NIL (value: '0')
 * @member STEAM_ID_NON_STEAM_GS (value: '2')
 * @member STEAM_FRIENDS_MAX_FRIENDS_GROUP_NAME (value: '64')
 * @member STEAM_FRIENDS_MAX_RICH_PRESENCE_KEY_LENGTH (value: '64')
 * @member STEAM_FRIENDS_MAX_RICH_PRESENCE_KEYS (value: '20')
 * @member STEAM_FRIENDS_MAX_RICH_PRESENCE_VALUE_LENGTH (value: '256')
 * @member STEAM_FRIENDS_PERSONA_NAME_MAX (value: '128')
 * @member STEAM_FRIENDS_ENUMERATE_FOLLOWERS_MAX (value: '50')
 * @member STEAM_FRIENDS_FRIENDS_GROUP_LIMIT (value: '100')
 * @member STEAM_FRIENDS_CHAT_METADATA_MAX (value: '8192')
 * @member STEAM_FRIENDS_PERSONA_NAME_MAX_UTF16 (value: '32')
 * @member STEAM_FRIENDS_GROUP_ID_INVALID (value: '-1')
 * @member STEAM_FRIENDS_INTERFACE_VERSION (value: '"SteamFriends015"')
 * @member STEAM_APPS_APP_PROOF_OF_PURCHASE_KEY_MAX (value: '240')
 * @member STEAM_APPS_INTERFACE_VERSION (value: '"STEAMAPPS_INTERFACE_VERSION008"')
 * @member STEAM_SCREENSHOTS_INVALID_SCREENSHOT_HANDLE (value: '0')
 * @member STEAM_SCREENSHOTS_UFS_TAG_TYPE_MAX (value: '255')
 * @member STEAM_SCREENSHOTS_UFS_TAG_VALUE_MAX (value: '255')
 * @member STEAM_SCREENSHOTS_MAX_TAGGED_PUBLISHED_FILES (value: '32')
 * @member STEAM_SCREENSHOTS_MAX_TAGGED_USERS (value: '32')
 * @member STEAM_SCREENSHOTS_THUMB_WIDTH (value: '200')
 * @member STEAM_SCREENSHOTS_INTERFACE_VERSION (value: '"STEAMSCREENSHOTS_INTERFACE_VERSION003"')
 * @member STEAM_USER_INTERFACE_VERSION (value: '"SteamUser019"')
 * @member STEAM_USER_ENCRYPTED_APP_TICKET_SYMMETRIC_KEY_LEN (value: '32')
 * @member STEAM_UTILS_INTERFACE_VERSION (value: '"SteamUtils009"')
 * @member STEAM_UGC_NUM_RESULTS_PER_PAGE (value: '50')
 * @member STEAM_UGC_DEVELOPER_METADATA_MAX (value: '5000')
 ...
 * @member STEAM_USER_STATS_STAT_NAME_MAX (value: '128')
 * @member STEAM_USER_STATS_LEADERBOARD_DETAILS_MAX (value: '64')
 * @member STEAM_USER_STATS_INTERFACE_VERSION (value: '"STEAMUSERSTATS_INTERFACE_VERSION011"')
 * @member STEAM_MUSIC_INTERFACE_VERSION (value: '"STEAMMUSIC_INTERFACE_VERSION001"')
 ...
 * @member STEAM_REMOTE_STORAGE_PUBLISHED_DOCUMENT_TITLE_MAX (value: '129')
 * @member STEAM_REMOTE_STORAGE_PUBLISHED_FILE_URL_MAX (value: '256')
 * @member STEAM_REMOTE_STORAGE_TAG_LIST_MAX (value: '1025')
 * @member STEAM_REMOTE_STORAGE_PUBLISHED_FILE_ID_INVALID (value: '0')
 * @member STEAM_REMOTE_STORAGE_PUBLISHED_FILE_UPDATE_HANDLE_INVALID (value: '-1')
 * @member STEAM_REMOTE_STORAGE_UGC_FILE_STREAM_HANDLE_INVALID (value: '-1')
 * @member STEAM_REMOTE_STORAGE_UGC_HANDLE_INVALID (value: '-1')
 * @member STEAM_REMOTE_STORAGE_ENUMERATE_PUBLISHED_FILES_MAX_RESULTS (value: '50')
 * @member STEAM_REMOTE_STORAGE_MAX_CLOUD_FILE_CHUNK_SIZE (value: '104857600')
 * @member STEAM_REMOTE_STORAGE_INTERFACE_VERSION (value: '"STEAMREMOTESTORAGE_INTERFACE_VERSION014"')
 * @member STEAM_MATCHMAKING_SERVER_QUERY_INVALID (value: '0xffffffff')
 * @member STEAM_MATCHMAKING_MAX_LOBBY_KEY_LENGTH (value: '255')
 * @member STEAM_MATCHMAKING_FAVORITE_FLAG_FAVORITE (value: '0x01')
 * @member STEAM_MATCHMAKING_FAVORITE_FLAG_HISTORY (value: '0x02')
 * @member STEAM_MATCHMAKING_FAVORITE_FLAG_NONE (value: '0x00')
 * @member STEAM_MATCHMAKING_SERVERS_INTERFACE_VERSION (value: '"SteamMatchMakingServers002"')
 * @member STEAM_MATCHMAKING_INTERFACE_VERSION (value: '"SteamMatchMaking009"')
 * @member STEAM_NETWORKING_POLL_GROUP_INVALID (value: '0')
 * @member STEAM_NETWORKING_SOCKETS_MAX_MESSAGE_SIZE_SEND (value: '524288')
 * @const_end
 */
