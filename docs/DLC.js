...
[[NOTE: NOTE Even if the user owns the DLC it doesn&#39;t mean that they have it installed in their local account, so you should additionally use the function ${function.} to make sure that it is before using it.
